...
#
# Script generated by Vivado on Sun Apr 21 12:57:01 +0300 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Documents/xilinx/riscv-example/maestro/pipelined_riscv/pipelined_riscv.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
